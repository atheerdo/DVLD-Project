...
namespace DVLD_BuisnessL
{
    public class clsApplication
    {
        ...
        public enum enApplicationType { NewDrivingLicense = 1,RenewDrivingLicense = 2,
        ...
        public string ApplicatintFullName
        {
            get
            {
        ...
        public bool Cancel()
        {
            //Here number 2 represent Cancel.
            return clsApplicationData.UpdateStatus(ApplicationID, 2);
        }

        public bool SetCopmplete()
        {
        ...
        {
            return clsApplicationData.DoesPersonHaveAnActiveApplication(PersonID, ApplicationTypeID);
        }

        public bool DoesPersonHaveAnActiveApplication(int ApplicationTypeID)
        {
            return DoesPersonHaveAnActiveApplication(this.ApplicantPersonID, ApplicationTypeID);
        }
